using Mist_GUI.Properties;

namespace Mist_GUI
{
    public partial class Form_Mist_GUI : Form
    {
        public Form_Mist_GUI()
        {
            InitializeComponent();
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_Mist_GUI));
